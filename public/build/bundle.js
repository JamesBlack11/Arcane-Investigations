    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "hero-title font-roboto text-green-50 svelte-1kpb5d6");
    			set_style(h1, "font-family", "'Poppins', sans-serif");
    			add_location(h1, file$6, 25, 12, 823);
    			attr_dev(div0, "class", "text-center");
    			add_location(div0, file$6, 24, 8, 785);
    			attr_dev(div1, "class", "container mx-auto px-4");
    			add_location(div1, file$6, 23, 4, 740);
    			attr_dev(section, "class", "hero-section svelte-1kpb5d6");
    			add_location(section, file$6, 22, 0, 705);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 63, 8, 2350);
    			...
    			add_location(input0, file$3, 68, 24, 2690);
    			attr_dev(div0, "class", "col w-1/2");
    			add_location(div0, file$3, 67, 20, 2642);
    			...
    			add_location(input1, file$3, 71, 24, 2921);
    			attr_dev(div1, "class", "col w-1/2");
    			add_location(div1, file$3, 70, 20, 2873);
    			attr_dev(div2, "class", "form-row flex space-x-4");
    			add_location(div2, file$3, 66, 16, 2584);
    			attr_dev(div3, "class", "form-group");
    			add_location(div3, file$3, 65, 12, 2543);
    			...
    			add_location(textarea, file$3, 76, 16, 3185);
    			attr_dev(div4, "class", "form-group");
    			add_location(div4, file$3, 75, 12, 3144);
    			attr_dev(button, "id", "submit");
    			attr_dev(button, "type", "submit");
    			attr_dev(button, "class", "btn btn-lg rounded-md bg-black text-black p-2 svelte-jwrxfz");
    			add_location(button, file$3, 78, 12, 3374);
    			attr_dev(form, "target", "_blank");
    			attr_dev(form, "action", "https://formsubmit.co/jschwartz374@gmail.com");
    			attr_dev(form, "method", "POST");
    			add_location(form, file$3, 64, 8, 2440);
    			attr_dev(div5, "class", "container max-w-md w-full mx-auto bg-cyan-500 p-6 bg-black rounded shadow-md md:w-1/2 p-4");
    			add_location(div5, file$3, 62, 4, 2238);
    			attr_dev(h2, "class", "p-5 mb-4");
    			add_location(h2, file$3, 82, 8, 3544);
    			attr_dev(i0, "class", "fas fa-envelope");
    			add_location(i0, file$3, 83, 23, 3613);
    			attr_dev(p0, "class", "p-5");
    			add_location(p0, file$3, 83, 8, 3598);
    			attr_dev(p1, "class", "p-5");
    			add_location(p1, file$3, 84, 8, 3699);
    			attr_dev(i1, "class", "fas fa-phone");
    			add_location(i1, file$3, 85, 23, 3755);
    			attr_dev(p2, "class", "p-5");
    			add_location(p2, file$3, 85, 8, 3740);
    			attr_dev(i2, "class", "fas fa-phone ");
    			add_location(i2, file$3, 86, 23, 3825);
    			attr_dev(p3, "class", "p-5");
    			add_location(p3, file$3, 86, 8, 3810);
    			attr_dev(div6, "class", "md:w-1/2 p-5");
    			add_location(div6, file$3, 81, 4, 3509);
    			attr_dev(div7, "id", "form");
    			attr_dev(div7, "class", "contact flex justify-center items-center min-h-screen  svelte-jwrxfz");
    			add_location(div7, file$3, 61, 0, 2155);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "container svelte-9bijcc");
    			add_location(div0, file, 84, 1, 1972);
    			attr_dev(div1, "class", "page-content svelte-9bijcc");
    			add_location(div1, file, 83, 0, 1944);
    			attr_dev(div2, "class", "grid-bg min-h-screen svelte-9bijcc");
    			add_location(div2, file, 78, 0, 1885);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
